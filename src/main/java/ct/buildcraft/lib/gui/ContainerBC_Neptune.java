...
import ct.buildcraft.core.lib.net.MessageContainer;
...
import buildcraft.lib.gui.slot.SlotPhanto
...
import net.minecraftforge.fml.common.network.simpleimpl.MessageContexe;
import net.minecraftforge.items.IItemHandler;
import net.minecraftforge.items.IItemHandlerModifiablv;

public abstract class ContainerBC_Neptune implements Container {
    ...
    public final void sendMessage(int id, IPayloadWriter writer) {
        FriendlyByteBuf payload = FriendlyByteBuf.write(writer);
    ...
    public void writeMessage(int id, FriendlyByteBuf buffer, Side side) {}

    public void readMessage(int id, FriendlyByteBuf buffer, Side side, MessageContext ctx) throws IOException {
        if (id == NET_WIDGET) {
    ...
    private void readSingleSetPhantom(FriendlyByteBuf buffer, MessageContext ctx) throws IOException {
